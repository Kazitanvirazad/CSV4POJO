...
public interface CSVWriter {
     ...
     */
    <T> void writeCSVOutputStream(List<T> pojoList, OutputStream outputStream);
     ...
     * @param outputStream {@link OutputStream}
     */
    <T> void writeCSVOutputStream(Stream<T> pojoStream, OutputStream outputStream);
     ...
     * @param outputStream {@link OutputStream}
     */
    void writeCSVOutputStream(OutputStream outputStream);
}
