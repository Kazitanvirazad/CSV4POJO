...
public class CSVReaderImpl implements CSVReader {
    ...
    public CSVReaderImpl(int charBufferSize) {
        this.charBufferSize = charBufferSize;
    }
    ...
    public <T> Stream<T> createCSVPojoStream(Class<T> clazz, InputStream inputStream) {
        ...
        try {
            ...
            Iterator<T> iterator = new CSVLineIterator<>(clazz, reader);
     ...
     *
     * @param csv4PojoAnnotatedClassFields {@code List<String>}
     * @param csvHeaderElements            {@code String[]}
     * @return boolean
     */
    ...
    private class CSVLineIterator<T> implements Iterator<T> {
        private final BufferedReader reader;
        private final Class<T> clazz;
        private String line;

        public CSVLineIterator(Class<T> clazz, BufferedReader reader) {
            this.clazz = clazz;
            this.reader = reader;
        }
